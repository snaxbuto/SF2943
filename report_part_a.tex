...
weekdays. We report the failure rather than add more parameters at this
stage.
...
$\hat Y_t$, which a low-order ARMA cannot fully absorb. The chosen ARMA(2,1)
still works well for the forecast, but a SARIMA model with a seasonal term at
lag 7 would be a natural alternative that targets this leftover structure
directly.
